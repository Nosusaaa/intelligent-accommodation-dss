...
export default function Home() {
  return (
    <div className="relative min-h-svh overflow-hidden bg-gradient-to-br from-teal-50 to-emerald-50">
      ...
      <div className="relative z-10 mx-auto flex min-h-svh max-w-5xl flex-col px-4 py-16 sm:px-6 lg:px-8">
        <header className="flex flex-1 flex-col items-center justify-center text-center">
          ...
          <p className="mt-5 max-w-2xl text-lg text-slate-700 sm:text-xl" style={{ textShadow: '0 1px 8px rgba(255,255,255,0.9)' }}>
        ...
        <section className="mt-12 flex justify-center pb-8 md:mt-16">
          <article
            className="group relative flex w-full max-w-md flex-col rounded-2xl border border-white/80 bg-white/80 p-8 shadow-xl backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:border-teal-200/80 hover:shadow-[0_20px_50px_-12px_rgba(13,148,136,0.3)] md:p-10"
          >
